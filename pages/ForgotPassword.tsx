  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 font-sans">
      ...
      <Card className="w-full max-w-md p-8 shadow-xl border-t-4 border-blue-600">
        <Link to="/login" className="flex items-center text-sm text-slate-500 hover:text-blue-600 mb-6 transition-colors font-medium">
        ...
        <p className="text-slate-500 mb-6 text-sm leading-relaxed">Digite seu e-mail cadastrado para receber o link de redefinição de senha.</p>
