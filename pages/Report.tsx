    ...
    <div className="bg-slate-200 min-h-screen p-8 print:p-0 print:bg-white font-sans text-slate-900">
      ...
      <div className="max-w-[210mm] mx-auto bg-white min-h-[297mm] shadow-2xl print:shadow-none p-[20mm] print:p-0 relative overflow-hidden print:w-full">
        ...
        <div className="mb-10 text-center bg-slate-50 py-4 border border-slate-100 rounded-lg print:border-none print:bg-transparent">
           ...
           <p className="mt-2 text-sm font-medium text-blue-700 bg-blue-50 inline-block px-3 py-1 rounded print:bg-transparent print:text-slate-600 print:p-0">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-4 text-xs text-center">
            <div className="border border-emerald-200 bg-emerald-50/50 p-2 rounded print:border-slate-300 print:bg-white">
              <span className="block font-bold text-emerald-700 mb-1 print:text-black">0 - 39 (Risco Baixo)</span>
              <span>Monitoramento periódico. Nenhuma ação imediata requerida.</span>
            </div>
            <div className="border border-amber-200 bg-amber-50/50 p-2 rounded print:border-slate-300 print:bg-white">
              <span className="block font-bold text-amber-700 mb-1 print:text-black">40 - 69 (Risco Moderado)</span>
              <span>Estado de atenção. Requer plano de ação para melhorias a médio prazo.</span>
            </div>
            <div className="border border-red-200 bg-red-50/50 p-2 rounded print:border-slate-300 print:bg-white">
              <span className="block font-bold text-red-700 mb-1 print:text-black">70 - 100 (Risco Alto)</span>
        ...
        <section className="mb-8 print:break-inside-avoid">
          ...
          <table className="w-full border-collapse text-sm border border-slate-300">
             <thead className="bg-slate-100 print:bg-slate-200">
               <tr>
                 <th className="border border-slate-300 p-2 text-left w-1/3">Fator de Risco (Perigo)</th>
                 <th className="border border-slate-300 p-2 text-center w-20">Probabilidade</th>
                 <th className="border border-slate-300 p-2 text-center w-20">Severidade</th>
                 <th className="border border-slate-300 p-2 text-center w-24">Nível de Risco</th>
                 <th className="border border-slate-300 p-2 text-left">Descrição / Evidência</th>
               </tr>
             </thead>
             <tbody>
               {[
                 ...
                 <tr key={i}>
                   ...
                   <td className="border border-slate-300 p-2 text-center">
                     <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded border ${
                        row.level === 'Alto' ? 'bg-red-50 border-red-200 text-red-700 print:text-black print:border-black' : 
                        row.level === 'Moderado' ? 'bg-amber-50 border-amber-200 text-amber-700 print:text-black print:border-black' : 
                        'bg-emerald-50 border-emerald-200 text-emerald-700 print:text-black print:border-black'
                     }`}>
                       {row.level}
                     </span>
                   </td>
        ...
        <section className="mb-10 print:break-inside-avoid">
           ...
           <table className="w-full border-collapse text-sm border border-slate-300">
             <thead className="bg-slate-100 print:bg-slate-200">
               <tr>
                 <th className="border border-slate-300 p-2 text-left font-semibold">O Que (Ação)</th>
                 <th className="border border-slate-300 p-2 text-left font-semibold">Por Que (Motivo)</th>
                 <th className="border border-slate-300 p-2 text-left font-semibold w-24">Responsável</th>
                 <th className="border border-slate-300 p-2 text-center font-semibold w-24">Prazo</th>
               </tr>
             </thead>
             <tbody>
                <tr>
        ...
        <footer className="absolute bottom-6 left-[20mm] right-[20mm] print:left-0 print:right-0 border-t border-slate-200 pt-2 flex justify-between items-center text-[10px] text-slate-400">
