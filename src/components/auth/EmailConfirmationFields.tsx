    ...
    <div className="space-y-4 w-full">
      ...
      <div className="w-full">
        ...
        <p className="text-[10px] text-slate-400 font-medium leading-tight mt-1.5 italic">
          Use um e-mail válido: é por ele que você acessará o sistema.
        </p>
      </div>
      ...
      <div className="w-full">
        ...
        <div className="relative">
          <input 
            type="email" 
            required
            onPaste={(e) => e.preventDefault()} // BLOQUEIO DEFINITIVO DE PASTE
        ...
        {mismatch ? (
          ...
          <p className="text-[10px] text-slate-400 font-medium leading-tight mt-1.5">
            Digite novamente para evitar erros de digitação.
          </p>
        )}
      </div>
    </div>
